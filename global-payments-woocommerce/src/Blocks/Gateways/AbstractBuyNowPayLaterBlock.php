...
use GlobalPayments\WooCommercePaymentGatewayProvider\PaymentMethods\BuyNowPayLater\AbstractBuyNowPayLater;
use GlobalPayments\WooCommercePaymentGatewayProvider\Plugin;

class AbstractBuyNowPayLaterBlock extends AbstractPaymentMethodType {
	protected AbstractBuyNowPayLater $paymentMethod;
	...
	public function get_payment_method_script_handles() {
		...
		wp_register_script(
			str_replace( '_', '-', $this->name ) . '-bnpl-gateways-blocks',
			$script_url,
